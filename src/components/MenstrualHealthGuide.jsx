  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Menstrual Health Guide</h2>
      </div>

      <div className="space-y-6">
        {/* Normal Cycle Information */}
        <div className="bg-blue-50 p-4 rounded-lg">
          <h3 className="text-lg font-semibold text-blue-800 mb-3">Normal Cycle Information</h3>
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <ul className="list-disc pl-5 space-y-2 text-green-700">
            <li>Use heating pads for cramps</li>
            <li>Stay hydrated</li>
...
export default MenstrualHealthGuide; 