            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <img class="h-8 w-auto mb-4" src={logo}
                        alt="Logo" />
                    <p class="text-sm text-gray-600">Your trusted partner in reproductive health.</p>
                </div>
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 mb-4">Quick Links</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">About Us</a></li>
                        <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Find a Doctor</a></li>
                        <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Health Resources</a></li>
                    </ul>
                </div>
                <div>
